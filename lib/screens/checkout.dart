...
class _CheckoutState extends State<Checkout> {
  ...
  uploadOrderToDatabase() async{
    ...
    await documentReference.set({
      ...
      "total": widget.total+widget.selectedRestaurant["deliveryCharge"],
  ...
  updatePointsToFirebase()async{
    print('cart model point '+widget.cartModel.points.toString());
    User user = FirebaseAuth.instance.currentUser;
    await firestoreInstance.collection("users").doc(user.uid).update({"points":widget.cartModel.points});
  }
