              ...
              onPressed: () async {
                if (_emailController.text == "" ||
                  ...
                  alertDialog(context, "Error",
                      "Por favor llena todos los espacios", "reintento");
                else
                  try {
                    ...
                    FirebaseAuth.instance
                      ...
                      if (user == null) {
                        ...
                        alertDialog(context, "Credenciales no válidas", "Inténtalo de nuevo", "reintento");
                      }
...
alertDialog(
    BuildContext context, String title, String message, String buttonTxt) {
...
alertDialogUserDoesNotExist(BuildContext context) {
  ...
  showDialog(
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        title: Text("Error"),
        content: Text("Inicio de sesión no válido Por favor regístrese!!"),
