...
//                    );
            ...
            ListTile(
              ...
              trailing: IconButton(
                ...
                onPressed: () async {
                  await alertDialogEditReference(context);
          ...
          return AlertDialog(
            ...
            content: TextField(
              ...
              decoration: InputDecoration(
                  hintText: "Ingrese nuevo nombre"), //Enter New First Name
            ),
            actions: <Widget>[
              new FlatButton(
        ...
        builder: (context) {
          return AlertDialog(
            ...
            content: TextField(
              ...
              textCapitalization: TextCapitalization.words,
              decoration: InputDecoration(
                  hintText: "Ingrese nuevo apellido"), //Enter New Last Name
            ),
            actions: <Widget>[
              new FlatButton(
                child: new Text('Cancelar'), //Cancel
        ...
        builder: (context) {
          return AlertDialog(
            ...
            content: TextField(
              ...
              decoration: InputDecoration(
                  hintText:
                      "Ingrese nuevo número de teléfono"), //Enter New Phone Number
            ),
            actions: <Widget>[
              new FlatButton(
  ...
  alertDialogEditReference(BuildContext context) async {
    TextEditingController _textFieldController = TextEditingController();
    User user = FirebaseAuth.instance.currentUser;
    final firestoreInstance = FirebaseFirestore.instance;
    return showDialog(
        ...
        builder: (context) {
          return AlertDialog(
            title: Text('Editar referencia'), //Edit Address
            content: TextField(
              maxLines: 3,
              controller: _textFieldController,
              textInputAction: TextInputAction.go,
              keyboardType: TextInputType.text,
              textCapitalization: TextCapitalization.words,
              decoration: InputDecoration(hintText: "Enter new reference"),
            ),
            actions: <Widget>[
              new FlatButton(
                child: new Text('Cancelar'),
              ...
              new FlatButton(
                ...
                onPressed: () {
                  firestoreInstance.collection("users").doc(user.uid).update({
                    "reference": _textFieldController.text,
                  }).then((value) {
                    print("Success");
                  });
                  reference = _textFieldController.text;
