...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  final TextEditingController referenceController = new TextEditingController();
            ...
            child: Container(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  hintText: "contrasena - por favor escriba más de 6 números",
                  //Password
                  prefixIcon: Icon(
                    Icons.lock_outline,
                    color: Colors.black,
            ...
            child: Container(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  hintText: "dirección - mexico 738 casi herrera",
                  //Password
                  prefixIcon: Icon(
                    Icons.pin_drop,
                    color: Colors.black,
            ...
            child: Container(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  hintText:
                      "referencia - la puerta blanca al lado de las estaciones de servicio",
                  //Password
                  prefixIcon: Icon(
                    Icons.pin_drop,
                    color: Colors.black,
            ...
            child: RaisedButton(
              ...
              onPressed: () async {
                if (_emailController.text == "" ||
                  ...
                  alertDialog(context,"Error", "Por favor llena todos los espacios","reintento");
                  ...
                  alertDialogPasswordsLength(context);
...
//                    }
                    firestoreInstance.collection("users").doc(user.uid).set({
                      ...
                      alertDialog(context,"Registro completado", "Por favor inicie sesión para continuar","OK");
                    });
...
alertDialog(BuildContext context,String title, String message, String buttonTxt) {
  // This is the ok button
  Widget ok = FlatButton(
    child: Text(buttonTxt), //Retry
    onPressed: () {
  ...
  showDialog(
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        title: Text(title),
        content: Text(message), //Passwords dont match
        actions: [
          ok,
        ],
        elevation: 5,
...
alertDialogPasswordsLength(BuildContext context) {
  // This is the ok button
  Widget ok = FlatButton(
    child: Text("reintento"), //Retry
    onPressed: () {
  ...
  showDialog(
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        title: Text("Error"),
        content: Text(
            "La longitud de la contraseña debe ser superior a 6 caracteres"),
  ...
  showDialog(
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        ...
        content: Text(
            "La longitud de la contraseña debe tener un mínimo de 6 caracteres"),
        actions: [
          ok,
        ],
        elevation: 5,
...
alertDialogCheckEmail(BuildContext context) {
  ...
  showDialog(
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        title: Text("El mensaje de verificación ha sido enviado "),
